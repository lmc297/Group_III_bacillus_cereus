...
# Step 2: Read in one of the following maximum likelihood (ML) phylogenies, constructed using core, majority, and all SNPs identifyied using kSNP3 and IQ-TREE
