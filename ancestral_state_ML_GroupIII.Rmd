...
## These commands use the make.simmap function, the all-rates-different model, 1,000 simulations of stochastic character histories using the fitted model and tree tip states, and a root node prior in which equal probability is assigned to the root node belonging to a *ces*-positive or *ces*-negative state

```{r}
### equal probability of ces-negative and ces-positive
