...
paranthracis <- read.beast(file = "snippy_relaxed_skyline_10burnin_MCC_CAnode_10burninLC_0burninTA.tree")
```
...
## These commands use the make.simmap function, the all-rates-different model, 10,000 simulations of stochastic character histories using the fitted model and tree tip states, and one of the following three priors on the root node, corresponding to the *ces*-positive and *ces*-negative state of the root node:
